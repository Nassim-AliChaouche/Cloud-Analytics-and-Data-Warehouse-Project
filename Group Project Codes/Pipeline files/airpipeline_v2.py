...
PROJECT_ID="group-project-data-225"
GS_PATH = "/starschematables"
BUCKET_NAME = 'gp6prbucket'
...
default_args = {
    ...
    'email_on_failure': ['nail.enikeev@gsjsu.edu', 'quan.gu@sjsu.edu', 'nassim.ali-chaouche@sjsu.edu'],
