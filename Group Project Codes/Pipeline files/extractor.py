...
default_args = {
    ...
    'email': ['nail.enikeev@gsjsu.edu', 'quan.gu@sjsu.edu', 'nassim.ali-chaouche@sjsu.edu'],
...
def get_tables():
    ...
    for dim in export_tables:
        tables.append(TableConfig(cloud_sql_instance='oltpdb',
                                  export_table=dim,
                                  export_bucket='gp6prbucket',
                                  export_database='usacc',
                                  export_query=TableConfig.STANDARD_EXPORT_QUERY,
                                  gcp_project="group-project-data-225",
